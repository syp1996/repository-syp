...
<div class="demo-block">
   <i-button @click="start">开始</i-button>
   <i-button @click="end">结束</i-button>
...
<div class="demo-block">
   <i-button @click="setSpeed">设置speed速度</i-button>
   <i-button @click="setSpinner">设置spinner动画效果</i-button>
   <i-button @click="setPercentNum">设置percentNum每次加载的比例</i-button>
   <i-button @click="setShowSpinner">设置是否显示spinner</i-button>
</div>
